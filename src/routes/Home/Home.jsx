      ...
      <div className="mb-12 overflow-hidden">
        ...
        <div>
          ...
          <div class="mt-10 grid grid-cols-1 lg:grid-cols-2  bg-[#000000]">
            <div id="carouselExampleAutoplaying" class="carousel slide carousel-fade" data-bs-ride="carousel" data-bs-interval="6000">
              <div class="carousel-inner">
                <div class="carousel-item active">
                  <img src={Imagem3} class=" rounded-2xl h-[25rem] w-100 object-cover object-center opacity-60 block" alt="..."></img>
                </div>
                <div class="carousel-item">
                  <img src={Imagem10} class=" rounded-2xl h-[25rem]  w-100 object-cover object-center opacity-60 block" alt="..."></img>
                </div>
                <div class="carousel-item">
                  <img src={Imagem7} class=" rounded-2xl h-[25rem]  w-100 object-cover object-center opacity-60 block" alt="..."></img>
                </div>
                <div class="carousel-item">
                  <img src={Imagem8} class=" rounded-2xl h-[25rem]  w-100 object-cover object-center opacity-60 block" alt="..."></img>
                </div>
              </div>
