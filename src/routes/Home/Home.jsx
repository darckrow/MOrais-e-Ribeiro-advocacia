...
const Home = () => {
 ...
 { /*AQUI FOI CRIADO UM CAROUSEL COM IMAGEM PASSANDO NA HOME*/}
        <div>
          <div class="mt-8 grid grid-cols-1 lg:grid-cols-2  bg-[#000000]">
            <div>
              <div id="carouselExampleFade" class="carousel slide carousel-fade" data-bs-ride="carousel">
                <div class="carousel-inner">
                  <div class="carousel-item active">
                    <img src={Imagem10} class="h-[35rem] w-full object-cover object-center" alt="..."></img>
                  </div>
                  <div class="carousel-item">
                    <img src={Imagem3} class="h-[35rem] w-full object-cover object-center" alt="..."></img>
                  </div>
                  <div class="carousel-item">
                    <img src={Imagem7} class="h-[35rem] w-full object-cover object-center" alt="..."></img>
                  </div>
                  <div class="carousel-item">
                    <img src={Imagem8} class="h-[35rem] w-full object-cover object-center" alt="..."></img>
                  </div>
                </div>
          ...
          <div>
            <div class="lg:py-5 opacity-50 flex flex-col items-center bg-gray-100 border border-gray-200 rounded-lg shadow md:flex-row hover:bg-gray-100 dark:border-gray-700 dark:bg-gray-800 dark:hover:bg-gray-700">
              <div class="flex flex-col justify-between p-4 leading-normal">
                <h5 class="mb-2 text-2xl font-bold tracking-tight text-gray-900 dark:text-white">Missão</h5>
                <p class="mb-3 font-normal text-gray-700 dark:text-gray-400 text-justify">Na Morais & Ribeiro Advocacia e Consultoria Jurídica, nossa missão é conduzida por três pilares fundamentais: foco, conhecimento e inovação. Estamos comprometidos em fornecer soluções jurídicas e de negócios que transcendam as expectativas de nossos clientes e desafiem os paradigmas tradicionais da advocacia.</p>
                <h5 class="mb-2 text-2xl font-bold tracking-tight text-gray-900 dark:text-white">Visão</h5>
                <p class="mb-3 font-normal text-gray-700 dark:text-gray-400 text-justify">Uma Sociedade de Advogados alinhada às transformações sociais e seus reflexos nas dinâmicas jurídicas, adotando e adaptando-se às inovações tecnológicas em constante evolução.</p>
              </div>
            </div>
