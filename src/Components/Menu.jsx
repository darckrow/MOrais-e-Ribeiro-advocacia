  ...
  const content = <>
    <div className="visible md:invisible md:hidden block absolute top-36 w-full left-0 right-0 bg-[#000000]">
      <ul className='text-center text-xl p-4 '>
        <Link spy={true} smooth={true} to="/"> <li className='hover:text-yellow-500 my-4 py-0 hover:rouded'>Home</li> </Link>
          ...
          <div className="lg:flex md:flex lg:flex-1 items center justify-end font-normal hidden">
            <div className="flex-10">
              <ul className="flex gap-6 mr-0 text-[17px]">
                <Link spy={true} smooth={true} to="/"> <li className='hover:text-yellow-500 transition cursor-pointer'>Home</li> </Link>
